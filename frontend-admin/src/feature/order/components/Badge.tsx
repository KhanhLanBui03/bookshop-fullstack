...
const STATUS_CONFIG: Record<BadgeLabel, StatusConfig> = {
    ...
    SHIPPING: { bg: "rgba(96,165,250,0.12)", color: "#93c5fd", dot: "#60a5fa" },
    PAID: { bg: "rgba(34,197,94,0.12)", color: "#4ade80", dot: "#22c55e" },
    CONFIRMED: { bg: "rgba(96,165,250,0.12)", color: "#93c5fd", dot: "#60a5fa" },
    PENDING: { bg: "rgba(245,158,11,0.12)", color: "#fcd34d", dot: "#f59e0b" },
    PENDING_PAYMENT: { bg: "rgba(245,158,11,0.12)", color: "#fcd34d", dot: "#f59e0b" },
    CANCELLED: { bg: "rgba(239,68,68,0.12)", color: "#fca5a5", dot: "#ef4444" },
    FAILED: { bg: "rgba(239,68,68,0.12)", color: "#fca5a5", dot: "#ef4444" },
    REFUNDED: { bg: "rgba(167,139,250,0.12)", color: "#c4b5fd", dot: "#a78bfa" },
